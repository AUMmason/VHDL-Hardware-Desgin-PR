...
vcom VHDL-Hardware-Desgin-PR/UE_8/tilt_debug_ea.vhd
vcom VHDL-Hardware-Desgin-PR/UE_8/tilt_debug_tb.vhd

# Start Simulation
vsim -voptargs="\+acc" -t ns tilt_debug_tb -wlf tilt_debug_tb_sim.wlf

# Label
add wave -divider Inputs

add wave -noupdate -color {Cornflower Blue} -radix symbolic /tilt_debug_tb/reset
add wave -noupdate -color {Cornflower Blue} -radix symbolic /tilt_debug_tb/clk

add wave -divider {Inputs: Switches}
add wave -noupdate -color {Cornflower Blue} -radix symbolic /tilt_debug_tb/sw_enable_debug_mode
add wave -noupdate -color {Cornflower Blue} -radix symbolic /tilt_debug_tb/sw_select_axis
add wave -noupdate -color Cyan -radix symbolic /tilt_debug_tb/sw_select_increment_amount

add wave -divider {Inputs: Buttons}
add wave -noupdate -radix symbolic /tilt_debug_tb/btn_increase
add wave -noupdate -color Red -radix symbolic /tilt_debug_tb/btn_decrease

# Label
add wave -divider Outputs

add wave -noupdate -radix symbolic /tilt_debug_tb/axis_pwm_pin
add wave -noupdate -radix symbolic /tilt_debug_tb/axis_servo_pwm_pin

add wave -noupdate -color Cyan -radix binary /tilt_debug_tb/LED_X00
add wave -noupdate -color Cyan -radix binary /tilt_debug_tb/LED_0X0
add wave -noupdate -color Cyan -radix binary /tilt_debug_tb/LED_00X

add wave -noupdate -color Cyan -radix binary /tilt_debug_tb/debug_led
...
add wave -noupdate -color {Cornflower Blue} -radix symbolic /tilt_debug_tb/tilt_debug/button_control/adc_valid_strobe_next

# Label
add wave -divider {PWM and Binary}
add wave -noupdate -color {Cornflower Blue} -radix unsigned /tilt_debug_tb/tilt_debug/pwm_servo_on_counter_val
add wave -noupdate -color {Cornflower Blue} -radix symbolic /tilt_debug_tb/tilt_debug/binary
